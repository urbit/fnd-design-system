    ...
    <>
      ...
      <button
        className={classnames(
          "flex lg:hidden fixed bottom-4 right-4 items-center justify-center leading-none w-12 h-12 text-4xl text-lite bg-brite rounded-full",
      ...
      >
        {isOpen ? (
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <rect width="16" height="3" rx="1.5" className="fill-gray" />
            <rect y="7" width="16" height="3" rx="1.5" className="fill-gray" />
            <rect y="14" width="16" height="3" rx="1.5" className="fill-gray" />
          </svg>
        )}
      </button>
    </>
